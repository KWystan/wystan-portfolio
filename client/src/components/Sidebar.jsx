...
export default function Sidebar({ mobileOpen, onClose }) {
  ...
  return (
    <>
      {/* ── Desktop sidebar ─────────────────────────────────── */}
      <aside className="hidden lg:flex fixed top-0 left-0 h-screen w-[244px] flex-col border-r border-black/8 bg-white z-40">
        {/* Noise overlay */}
                ...
                return (
                  <li key={link.label}>
                    <Link
                      to={link.href}
                      onClick={onClose}
                      className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-all duration-150 active:scale-[0.97] ${
                        isActive
                          ? 'bg-black/[0.04] text-black font-medium'
                          : 'text-black/45 hover-gate:text-black hover-gate:bg-black/[0.02]'
                      }`}
                    >
                ...
                return (
                  <li key={link.label}>
                    <Link
                      to={link.href}
                      onClick={onClose}
                      className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-150 active:scale-[0.97] ${
                        isActive
                          ? 'bg-black/[0.04] text-black font-medium'
                          : 'text-black/45 hover-gate:text-black hover-gate:bg-black/[0.02]'
                      }`}
